...
export declare type Frame = FrameiBeacon | FrameUID | FrameAccSensor | FrameHTSensor | FrameTLM | FrameURL | FrameLightSensor | FrameForceSensor | FramePIRSensor | FrameTempSensor | FrameTVOCSensor | FrameLineBeacon | FrameDeviceInfo;
